...
class YCBobjectsCfg:
    ...
    ycb_name = ['sugarBox',"mustardBottle","tomatoSoupCan",'Cube','Cube3','Cube2']
...
class RewardsCfg:
    ...
    #reward_for_toy_example = {"weight": 1}
    '''reward for toy example v2'''
    check_placing = {"weight": 0.4} ##Feb 1 do not terminate
    reward_og_change = {"weight": 0.15}
    # reward_near_obj = {"weight": 1}
    # reward_reaching = {"weight": 0.25}
    outside_zone = {"weight": 0.1}
    penaltizing_falling = {"weight": 0.25} ## DEc20_00-56-30
    ...
    penaltizing_pushing_outside = {"weight":0.25} ## Dec24_16-21-23 before
    #penaltizing_pushing_outside = {"weight":0.9}
    reward_max_tsdf_increase = {"weight": 0.1}
...
class ObjMask:
    def __init__(self) -> None:
        ...
        obj_name = ['crackerBox','sugarBox','tomatoSoupCan','mustardBottle','mug','largeMarker','tunaFishCan',
                'banana','bowl','largeClamp','scissors','Cube','Cube3','Cube2']
...
class PushEnvCfg(IsaacEnvCfg):
    ...
    # General Settings
    env: EnvCfg = EnvCfg(num_envs=4096, env_spacing=2.5, episode_length_s=0.12)
