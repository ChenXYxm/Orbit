...
class RewardsCfg:
    ...
    reward_max_tsdf_increase = {"weight": 2}
...
class occupancy_grid_resolution:
    ...
    default_tabletop = [50,50]
    default_new_obj = [40,40]
    default_resolution = 0.01
    resoltion = 0.005
    
    scale = default_resolution/resoltion
    tabletop = [int(default_tabletop[0]*scale),int(default_tabletop[1]*scale)]
    new_obj = [int(default_new_obj[0]*scale),int(default_new_obj[1]*scale)]
@configclass
class ControlCfg:
