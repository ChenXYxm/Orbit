...
from .push_cfg_v11 import PushEnvCfg, RandomizationCfg, YCBobjectsCfg, CameraCfg
    ...
    def _check_placing(self):
        ...
        for i in range(self.num_envs):
            ...
            if flag_found:
                ...
                env_ids_tmp = torch.from_numpy(np.array([i])).to(self.device)
                self._place_obj(pos,rot,env_ids_tmp)
