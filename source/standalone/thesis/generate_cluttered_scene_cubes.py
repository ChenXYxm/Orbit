    ...
    for i in range(1000):
        ...
        while obj_dict[ycb_name[0]] < 15:
            ...
            if flag_found:
                ...
                file_name_ori = "dict_"
                file_list = os.listdir("generated_table4/")
                flag_done = True
                print('done')
                ...
                while True:
                    ...
                    if file_name in file_list:
                        ...
                        file_path = "generated_table4/"+file_name
                ...
                # f_save.close()
                break
        if obj_dict[ycb_name[0]] >= 15 and not flag_done:
            file_name_ori = "dict_"
            file_list = os.listdir("generated_table4/")
            print('too many cubes been placed')
            print(table_obj_pos_rot)
            for k in table_obj_pos_rot:
                print(len(table_obj_pos_rot[k]))
            num_file = 1
