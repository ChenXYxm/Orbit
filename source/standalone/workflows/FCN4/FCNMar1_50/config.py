...
SB3_PPO_CONFIG_FILE = {
    ...
    "Isaac-Push-Place-42-Franka-v0": os.path.join(ORBIT_ENVS_DATA_DIR, "sb3/toy_ppo.yaml"),
    "Isaac-Push-Place-50-Franka-v0": os.path.join(ORBIT_ENVS_DATA_DIR, "sb3/toy_ppo.yaml"),
}
