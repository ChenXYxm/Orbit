...
Transition = namedtuple("Transition", ("state", "action", "next_state", "reward","orientation"))
...
class MULTIDISCRETE_RESNET_Rotate(nn.Module):
    def __init__(self, number_actions_dim_2=1): 
        ...
        if torch.cuda.is_available():
            ...
            self.use_cuda = False
    def forward(self,state,rotatation):
        # self.output_prob = []
        # self.interm_feat = []
        # obs_tmp = x.clone().cpu()
