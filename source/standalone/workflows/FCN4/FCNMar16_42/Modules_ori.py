...
class Perception_Module(nn.Module):
    def __init__(self):
        ...
        # self.RB6 = BasicBlock(1024, 2048)
        # self.RB5 = BasicBlock(1024, 1024)
        vgg16 = models.vgg16(pretrained=True)
        vgg16.features[0] = nn.Conv2d(2, 64, kernel_size=3, padding=1)
        # Extract only the convolutional layers of VGG
...
class Grasping_Module_multidiscrete(nn.Module):
    def __init__(self, output_activation="Sigmoid", act_dim_2=1):
        ...
        # self.UP02 = nn.UpsamplingBilinear2d(scale_factor=2)
        self.RB01 = BasicBlock(512, 512)
        self.UP00 = nn.UpsamplingBilinear2d(scale_factor=2)
        self.RB02 = BasicBlock(512, 512)
        self.RB03 = BasicBlock(512, 512)
        self.UP0 = nn.UpsamplingBilinear2d(scale_factor=2)
        #############################
        self.RB1 = BasicBlock(512, 512)
        self.UP01 = nn.UpsamplingBilinear2d(scale_factor=2)
        self.RB2 = BasicBlock(512, 256)
        self.UP1 = nn.UpsamplingBilinear2d(scale_factor=2)
        self.RB04 = BasicBlock(256, 128)
        self.RB3 = BasicBlock(128, 64)
...
class MULTIDISCRETE_RESNET_Rotate(nn.Module):
    def __init__(self, number_actions_dim_2=1): # , snapshot=None
        super().__init__() 
    ...
    def forward(self,state):
        ...
        for rotate_idx in range(rotate_num):
            ...
            # obs_feature_rotated_back[0,0,30,10] = 2
