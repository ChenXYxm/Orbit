...
class Push_Agent():
    def __init__(self,env,num_envs,device) -> None:
        ...
        # pretrained_dict = torch.load('/home/chenxiny/Downloads/weight37800.pth')
        self.saved_changed = {}
        for i in range(self.num_envs):
            self.saved_changed[i] = []
        # print(self.saved_changed)
        # checkpoint = torch.load('/home/chenxiny/orbit/Orbit/FCN_regression/weight6400.pth')
