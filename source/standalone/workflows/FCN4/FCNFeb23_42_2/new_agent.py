...
class Push_Agent():
    def __init__(self,env,num_envs,device) -> None:
        ...
        # checkpoint = torch.load('/home/chenxiny/orbit/Orbit/FCN_regression/weight36000.pth')
        # checkpoint = torch.load('/home/cxy/Downloads/weight31200_Mar28_without_mask.pth')
        checkpoint = torch.load('/home/cxy/Downloads/weight27600.pth')
    ...
    def train(self):
        ...
        while self.steps_done<300000:
            ...
            # self.learn()
            if self.steps_done>=1800*self.save_i:
                self.save_i += 1
