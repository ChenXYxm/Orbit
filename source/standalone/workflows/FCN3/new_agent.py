...
class Push_Agent():
        ...
        while self.steps_done<300000:
            ...
            for i in range(i_range):
                ...
                for j in range(len(self._last_obs)):
                    ...
                    del next_obs_tensor,rewards_tmp
    ...
    def learn(self):
        ...
        for i in range(1):
            ...
            q_pred = (
                self.policy_net(state_batch).view(3, -1).gather(1, action_batch)
            )
            # print('q_pred')
            ...
            q_next_state = self.target_net(next_state_batch).view(3, -1).max(1)[0].unsqueeze(1).detach()
            print('q_pred')
