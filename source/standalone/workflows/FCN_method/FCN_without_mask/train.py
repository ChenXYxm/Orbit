...
parser.add_argument("--save_path", type=str, default=None, help="Path to model checkpoint.")
...
def main():
    ...
    env.seed(seed=0)
    obs = env.reset()
    agent = Push_Agent(env=env,num_envs=args_cli.num_envs,device=device,save_path=args_cli.save_path)
    agent.train()
