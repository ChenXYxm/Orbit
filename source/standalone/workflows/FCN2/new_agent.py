...
class Push_Agent():
    ...
    def epsilon_greedy(self, state):
        ...
        if sample > self.eps_threshold:
            ...
            with torch.no_grad():
                ...
                occu[int(max_idx/144)-4:int(max_idx/144)+5,int(max_idx%144)-3:int(max_idx%144)+4] = 3
        ...
        # of the selected pixel and resample until you get a pixel corresponding to a point on the table
            ...
            self.last_action = "random"
            action = random.randrange(int(144*144))
    ...
    def transform_action(self, action):
        ...
        action_1 = action_value // 144
        action_2 = action_value % 144
    ...
    def train(self):
        ...
        i_range = int(np.ceil(16/len(self._last_obs)))
    ...
    def learn(self):
        ...
        for i in range(1):
            ...
            q_pred = (
                self.policy_net(state_batch).view(16, -1).gather(1, action_batch)
            )
            print('q_pred')
            ...
            q_next_state = self.target_net(next_state_batch).view(16, -1).max(1)[0].unsqueeze(1).detach()
            print('q_pred')
