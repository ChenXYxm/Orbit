...
parser.add_argument("--save_path", type=str, default='./logs/', help="Path to model checkpoint.")
...
import torch
from source.standalone.workflows.sb3_customized.customized_PPO.ppo import PPO
...
def main():
    ...
    # callbacks for agent
    checkpoint_callback = CheckpointCallback(save_freq=600, save_path=args_cli.save_path, name_prefix="model", verbose=2)
    # train the agent
