...
```
./orbit.sh -p source/standalone/workflows/sb3/play.py --num_envs 1 --task Isaac-Push-50-PPO-val-Franka-v0 --checkpoint /path # checkpoint indicates the path to the trained model
