    ...
    def collect_rollouts(
        ...
        while n_steps < n_rollout_steps:
            ...
            for _ in range(len(self._last_obs)):
                if act_app[_] == 2:
                    clipped_actions[_,0] = 49-clipped_actions[_,1]
                    clipped_actions[_,1] = clipped_actions_origin[_,0]
                elif act_app[_] == 4:
                    clipped_actions[_,0] = 49-clipped_actions[_,0]
                    clipped_actions[_,1] = 49-clipped_actions_origin[_,1]
                elif act_app[_] == 6:
                    clipped_actions[_,0] = clipped_actions[_,1]
                    clipped_actions[_,1] = 49-clipped_actions_origin[_,0]
            ################################# changed in Dec 26
            for _ in range(len(self._last_obs)):
                if float(values[_]) <=-0.1:
                    act_app[_] = 10
            #print(act_app)
            ##########################################
